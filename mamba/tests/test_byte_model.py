...
print("x:", x)
print("x:", byte_tokens_to_text(x.squeeze(dim=0).tolist()))
...
print(x1)
print("x1:", byte_tokens_to_text(x1.squeeze(dim=0).tolist()))

print(x2)
print("x2:", byte_tokens_to_text(x2.squeeze(dim=0).tolist()))
